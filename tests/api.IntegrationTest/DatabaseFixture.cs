...
namespace api.IntegrationTest
{
    ...
    public class DatabaseProductDummy
    {
        public ProductsContext productContext {get;}

        public DatabaseProductDummy(string _databaseName = "product")
        {
            DbContextOptionsBuilder<ProductsContext> builder = new DbContextOptionsBuilder<ProductsContext>();
            DbContextOptions<ProductsContext> _productOptions = builder.UseInMemoryDatabase(_databaseName).Options;
            productContext = new ProductsContext(_productOptions);
